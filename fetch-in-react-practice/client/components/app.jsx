...
export default class App extends React.Component {
  ...
  addTodo(newTodo) {
    ...
    */
    const shallowHal = this.state.todos;
    fetch('/api/todos', {
      method: 'POST',
      headers: {
      ...
      .then(response => response.json())
      .then(data => shallowHal.concat(data))
      .then(shallowHal => this.setState({
        todos: shallowHal
      }))
      .catch(error => console.error(error));
  }
  ...
  toggleCompleted(todoId) {
    ...
    const status = { isCompleted: !this.state.todos[index].isCompleted };
